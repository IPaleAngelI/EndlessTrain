...
namespace Starter.ThirdPersonCharacter
{
	...
	public sealed class Player : NetworkBehaviour
	{
		...
		[Networked]
		public Vector3 _moveVelocity { get; set; }
		[Networked]
		...
		private int _animIDMotionSpeed;
            ...
            private void OnCollisionEnter(Collision collision)
            {
                ...
                if (objTag == "Train")
                {
                    this.transform.parent = collision.transform; // Устанавливаем поезд как родителя
                    _moveVelocity = (Vector3.zero); // Останавливаем движение персонажа
                }
            }
            ...
            private void OnCollisionExit(Collision collision)
            {
                ...
                if (objTag == "Train")
                {
                    this.transform.parent = null; // Возвращаем персонажа к его родителю
                }
            }
